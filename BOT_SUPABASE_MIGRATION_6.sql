...
-- Não toca em: products, orders, bot_conversations, store_bot_settings
-- ============================================================
...
-- ── 4. Popular store_id em registros existentes ──────────────
...
alter table bot_sessions    add constraint bot_sessions_store_phone_unique unique (store_id, phone);
...
alter table bot_leads       add constraint bot_leads_store_phone_unique unique (store_id, phone);
...
alter table bot_optouts     add constraint bot_optouts_store_phone_unique unique (store_id, phone);
...
alter table bot_flow_config add constraint bot_flow_config_store_node_unique unique (store_id, node_id);

-- ── 7. Índices (apenas colunas que garantidamente existem) ────
